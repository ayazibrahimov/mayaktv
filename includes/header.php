...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="assets/img/imgdatas/mayakfavicon.jpg">
                        ...
                        <div class="tgmenu__wrap">
                            <nav class="tgmenu__nav">
                                ...
                                <div class="tgmenu__navbar-wrap tgmenu__main-menu d-none d-lg-flex">
                                    <ul class="navigation">
                                        <li class="active menu-item-has-children"><a href="index-2.php">ANA SƏHİFƏ</a> </li>
                                        <li><a href="navNews.php">TƏMİZ SÖHBƏT</a> </li>
                                        <li><a href="navNews.php">SAĞLAM OL</a></li>
                                        <li><a href="navNews.php">GƏLİN OXUYAQ</a></li>
                                        <li class="menu-item-has-children"><a href="navNews.php">SƏN BACARARSAN</a>
                                            <!-- <ul class="sub-menu">
